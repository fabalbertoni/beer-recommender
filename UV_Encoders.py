...
class UV_Encoder(nn.Module):
    ...
    def forward(self, nodes):
        ...
        # TODO transform the list of ratings to embeddings, or directly pass to them to the network below. Probably the 2nd works just Ok.
        # ^ Yes, the aggregator computes the embedding from the list of ratings
